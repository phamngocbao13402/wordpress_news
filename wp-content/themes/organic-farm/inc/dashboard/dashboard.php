...
function organic_farm_guide() {
	...
	<div class="getting-started__header">
		<div class="col-md-10">
			...
			<p><?php esc_html_e('Version: ', 'organic-farm'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
		<div class="col-md-2">
			<div class="btn_box">
	...
	<div class="wrap getting-started">
		<div class="container">
			...
			<div class="col-md-3">
				...
				<img class="organic_farm_img_responsive" style="width: 100%;" src="<?php echo esc_url( $theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<hr>
