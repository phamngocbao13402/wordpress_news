...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
    <h1><?php the_title(); ?></h1>
    <?php if( get_theme_mod( 'food_grocery_store_toggle_postdate',true) != '' || get_theme_mod( 'food_grocery_store_toggle_author',true) != '' || get_theme_mod( 'food_grocery_store_toggle_comments',true) != '' || get_theme_mod( 'food_grocery_store_toggle_time',true) != '') { ?>
