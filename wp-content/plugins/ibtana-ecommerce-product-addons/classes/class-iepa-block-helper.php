		...
		public static function get_add_to_cart_css( $attr, $id ) {
			...
			$selectors	=	array(
				' .single_add_to_cart_button' => array(
					'color'							=>	isset( $attr['cartTextColor'] ) ? $attr['cartTextColor'] . ' !important' : '#000000',

					'border'						=>	$attr['buttonBorderSize'] . 'px solid ' . $attr['cartBorderColor'] . ' !important',
				...
				' .qty'	=>	array(
					...
					'color'							=>	$attr['quantityTextColor'],

					'background-color'	=>	$attr['quantityBackgroundColor'],
					'border'						=>	$attr['quantityBorderSize'] . 'px solid' . $attr['quantityBorderColor'],
					'border-radius'			=>	$attr['quantityBorderRadius'] . '%'
				)
			);
		...
		public static function get_product_price_css( $attr, $id ) {
			...
			$selectors	=	array(
				' del'				=>	array(
					...
					'color'						=>	$attr['regularPriceFontColor']
				),
				' del:hover'	=>	array(
					'color'						=>	$attr['regularPriceHoverColor']
				),
				' del bdi'		=>	array(
					'color'						=>	$attr['regularPriceFontColor']
				),
