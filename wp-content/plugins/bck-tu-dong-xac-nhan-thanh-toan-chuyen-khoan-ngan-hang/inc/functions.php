...
add_action( 'admin_notices', function () {
    ...
    <div class="notice notice-success bck-notice">
    	...
    	<ul>
    		...
    		<li>Hỗ trợ QR code tự nhập tiền và nội dung đơn hàng (API tiêu chuẩn của Napas - <a href="https://www.vietqr.io/" target="_blank">Vietqr.io</a>)</li>
    		<li><b>Xác nhận thanh toán tự động & kích hoạt đơn hàng từ 1~5 giây</b>.</li>
    	...
    	<p>Với 1 chiếc điện thoại, bạn tích hợp <b style="color:red">KHÔNG GIỚI HẠN</b> website, <b style="color:red">KHÔNG GIỚI HẠN</b> tài khoản và số lượng giao dịch.</p>
